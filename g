<html>
  ...
  <body>
    <div id="base">
      <img src="dial.png" class="clock"><!--文字盤-->
      <img src="hour.png" id="hour" class="clock"><!--短針-->
      <img src="minute.png" id="minute" class="clock"><!--長針-->
      <img src="second.png" id="second" class="clock"><!--秒針-->
    </div>
    <script>
      var time;
